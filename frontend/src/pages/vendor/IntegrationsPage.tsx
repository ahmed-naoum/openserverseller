  ...
  return (
    <div className="max-w-4xl mx-auto pb-12 animate-fade-in">
      ...
      <div className="space-y-8">
        ...
        {/* Placeholder if no integrations available */}
        {user?.role !== 'VENDOR' && (
          <div className="bg-white rounded-3xl p-12 text-center border-2 border-dashed border-gray-200">
            <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-4">
              <Link2 size={32} className="text-gray-300" />
            </div>
            <p className="text-xl font-bold text-gray-900">Aucune intégration disponible</p>
            <p className="text-gray-500 mt-2">Les intégrations API ne sont actuellement disponibles que pour les comptes Vendeurs.</p>
          </div>
        )}
      </div>
    </div>
