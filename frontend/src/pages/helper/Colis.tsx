...
const paymentConfig: Record<string, { label: string; color: string; bg: string }> = {
  NOT_PAID: { label: 'Non payé', color: 'text-red-600', bg: 'bg-red-50 border-red-200' },
  PAID: { label: 'Payé', color: 'text-emerald-600', bg: 'bg-emerald-50 border-emerald-200' },
  FACTURED: { label: 'Facturée', color: 'text-blue-600', bg: 'bg-blue-50 border-blue-200' },
};
